...
\begin{figure}[H]  % 禁止浮动
  \centering  % 表格居中
  \includegraphics[scale=.5]{figure/thesis/texliveImages.png}  % 选项代表缩小到原图的 0.5 倍。
...
\begin{figure}[H]  % 禁止浮动
  \centering  % 表格居中
  \includegraphics[scale=.5]{figure/thesis/installbat.png}  % 选项代表缩小到原图的 0.5 倍。
  \caption{运行安装程序}  % 图题
...
\begin{figure}[H]  % 禁止浮动
  \centering  % 表格居中
  \includegraphics[scale=.5]{figure/thesis/texliveInstaller.png}  % 选项代表缩小到原图的 0.5 倍。
...
\begin{figure}[H]  % 禁止浮动
  \centering  % 表格居中
  \includegraphics[scale=.45]{figure/thesis/texworkln.png}  % 选项代表缩小到原图的 0.5 倍。
  \caption{勾选行号}  % 图题
...
\begin{figure}[H]  % 禁止浮动
  \centering  % 表格居中
  \includegraphics[scale=.45]{figure/thesis/texworkpt.png}  % 选项代表缩小到原图的 0.5 倍。
  \caption{设置默认处理工具}  % 图题
